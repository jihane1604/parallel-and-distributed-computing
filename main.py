...
from src.processes import run_loop_processes, run_pool_map, run_pool_map_async, run_pool_apply, run_pool_apply_async, run_pool_apply_chunk, run_pool_apply_async_chunk, run_executor

# seq_time = run_seq(7)
# loop_process_time = run_loop_processes(6)
# apply_time = run_pool_apply(7)
# apply_async_time = run_pool_apply_async(7)
apply_chunk_time = run_pool_apply_chunk(6)
apply_async_chunk_time = run_pool_apply_async_chunk(6)
...
print(f"Pool apply execution time (with chunking): {apply_chunk_time}\n")
print(f"Pool apply async execution time (with chunking): {apply_async_chunk_time}\n")
